    ...
    var S = function(g) {
        ...
        function I(a, b, c) {
            ...
            g.each(b, function(e) {
                ...
                if (d !== k && (c || b[d] === k))
                    "o" === d.charAt(0) ?
                    (b[d] || (b[d] = {}), g.extend(!0, b[d], b[e]), I(a[d], b[d], c)) :
                    (b[d] = b[e]);
            });
        }
        ...
        function S(a) {
            var b = m.defaults.oLanguage,
                c = a.sZeroRecords;
            !a.sEmptyTable &&
                (c && "No hay datos en la tabla" === b.sEmptyTable) &&
        ...
        function gb(a) {
            var a = a.oBrowser,
                ...
                .append(
                    ...
                    .append(
                        g('<div class="test"/>').css({ width: "100%", height: 10 })
                    )
                )
                .appendTo("body"),
                c = b.find(".test");
                ...
                for (e = b.length - 1; 0 <= e; e--) {
                    ...
                    for (h = r.length; f < h; f++)
                        ...
                        for (j = l.length; i < j; i++)
                            ("_all" == r[f] || g(l[i].nTh).hasClass(r[f])) && d(i, n);
                    }
                }
            if (c) {
                e = 0;
        ...
        function Ka(a, b, c, d) {
            ...
            if (null === e.nTr) {
                ...
                for (r = a.aoColumns.length; l < r; l++) {
                    ...
                    g.fnCreatedCell &&
                        g.fnCreatedCell.call(a.oInstance, j, y(a, b, l), f, b, l);
                }
                ...
                for (e = h.length; d < e; d++) {
                    ...
                    for (b = h[d].length; f < b; f++)
                        if (((n = j = 1), i[d][f] === k)) {
                            ...
                            for (
                                i[d][f] = 1; h[d + j] !== k && h[d][f].cell == h[d + j][f].cell;
        ...
        function M(a) {
            ...
            if (-1 !== g.inArray(!1, b)) C(a, !1);
                ...
                h !== k &&
                    -1 !== h &&
                    ((a._iDisplayStart = i ? h : h >= a.fnRecordsDisplay() ? 0 : h),
        ...
        function nb(a) {
            ...
            for (
                var f = a.sDom.split(""), h, i, j, n, l, r, q = 0; q < f.length; q++
            ) {
                h = null;
                i = f[q];
                if ("<" == i) {
                ...
                h &&
                    ((j = a.aanFeatures), j[i] || (j[i] = []), j[i].push(h), e.append(h));
            }
            c.replaceWith(e);
            a.nHolding = null;
        }
            ...
            for (j = c.length; f < j; f++) {
                ...
                for (e = d.firstChild; e;) {
                    if (
                        ...
                        for (i = 0; i < l; i++)
                            for (h = 0; h < r; h++)
                                (a[f + h][n + i] = { cell: e, unique: q }), (a[f + h].nTr = d);
                    }
                    e = e.nextSibling;
                }
            }
        ...
        function pb(a) {
            var b = a.oClasses,
                ...
                .bind("keyup.DT search.DT input.DT paste.DT cut.DT", h ? ua(f, h) : f)
        ...
        function yb(a) {
            for (
                var b = m.ext.search, c = a.aiDisplay, d, e, f = 0, h = b.length; f < h; f++
            ) {
        ...
        function xb(a, b, c, d, e, f) {
            if ("" !== b)
                for (
                    var h = a.aiDisplay, d = Ra(b, d, e, f), e = h.length - 1; 0 <= e; e--
                )
            ...
            for (f = a.aoData.length; d < f; d++)
                if (((g = a.aoData[d]), !g._aFilterData)) {
                    ...
                    for (h = b.length; e < h; e++)
                        ...
                        j.indexOf &&
                        -1 !== j.indexOf("&") &&
                        ((wa.innerHTML = j), (j = $b ? wa.textContent : wa.innerText)),
                ...
                if (f) {
                    for (m = h = 0; m < j.length; m++)
                        ...
                        (h +=
                            null === o.sWidthOrig ?
                            e :
                            parseInt(o.sWidth, 10) + e - g(n[m]).width());
                    i.width(u(h));
                    b.style.width = u(h);
                }
                for (m = 0; m < j.length; m++)
        ...
        function V(a) {
            ...
            for (a = 0; a < n.length; a++) {
                ...
                for (c = f.length; b < c; b++)
                    (h = f[b]),
                    (i = e[h].sType || "string"),
                    n[a]._idx === k && (n[a]._idx = g.inArray(n[a][1], e[h].asSorting)),
                    d.push({
                        src: j,
                        col: h,
                        dir: n[a][1],
                        ...
                        for (i = 0; i < j; i++)
                            if (
                                ((g = n[i]),
                                    (c = k[g.col]),
                                    (h = m[g.col]),
                                    (g = e[g.type + "-" + g.dir] || e["string-" + g.dir]),
                                    (c = g(c, h)),
                                    0 !== c)
                            )
                                return c;
        ...
        function xa(a) {
            ...
            if (e.bSort && e.bSortClasses) {
                ...
                for (f = b.length; e < f; e++)
                    (h = b[e].src),
                    g(D(a.aoData, "anCells", h)).removeClass(c + (2 > e ? e + 1 : 3));
                e = 0;
                for (f = d.length; e < f; e++)
                    (h = d[e].src),
                    g(D(a.aoData, "anCells", h)).addClass(c + (2 > e ? e + 1 : 3));
            }
            a.aLastSort = d;
        }
        ...
        function Jb(a, b) {
            ...
            for (
                var f,
                    ...
                    i = 0,
                    g = a.aoData.length; i < g; i++
            )
                if (
                    ((c = a.aoData[i]),
                        c._aSortData || (c._aSortData = []), !c._aSortData[b] || d)
                )
                    (f = d ? e[i] : y(a, i, b, "sort")), (c._aSortData[b] = h ? h(f) : f);
        }
        ...
        function Lb(a) {
            ...
            if (a.oFeatures.bStateSave) {
                ...
                if (
                    e &&
                    e.time &&
                    ((b = w(a, "aoStateLoadParams", "stateLoadParams", [a, e])), -1 === g.inArray(!1, b) &&
                        ((b = a.iStateDuration), !(0 < b && e.time < +new Date() - 1e3 * b) &&
        ...
        function w(a, b, c, d) {
            ...
            null !== c &&
                ((b = g.Event(c + ".dt")), g(a.nTable).trigger(b, d), e.push(b.result));
            return e;
        }
        ...
        m = function(a) {
            ...
            this.fnAddData = function(a, b) {
                var c = this.api(!0),
                    d =
                    g.isArray(a) && (g.isArray(a[0]) || g.isPlainObject(a[0])) ?
                    c.rows.add(a) :
                    c.row.add(a);
                (b === k || b) && c.draw();
                ...
                if ("table" != this.nodeName.toLowerCase())
                    ...
                    null !== f.iDeferLoading &&
                        ((o.bDeferLoading = !0),
                            ...
                            (o._iRecordsDisplay = e ? f.iDeferLoading[0] : f.iDeferLoading),
                            (o._iRecordsTotal = e ? f.iDeferLoading[1] : f.iDeferLoading));
                    var t = o.oLanguage;
                    ...
                    0 === i.length || 0 === i.children().length ?
                        ...
                        0 < i.length && ((o.nTFoot = i[0]), ea(o.aoFooter, o.nTFoot));
                    if (f.aaData)
        ...
        t.register = p = function(a, b) {
            if (g.isArray(a))
                ...
                for (
                    var e = a.split("."), f = Ub, h, i, c = 0, d = e.length; c < d; c++
                ) {
                    ...
                    j ||
                        ((j = { name: h, val: {}, methodExt: [], propExt: [] }), f.push(j));
        ...
        var $a = function(a, b, c, d, e) {
                ...
                for (n = b.length; j < n; j++) {
                    ...
                    for (m = i.length; l < m; l++)
                        (h = c("string" === typeof i[l] ? g.trim(i[l]) : i[l])) &&
                        h.length &&
                        f.push.apply(f, h);
                }
                a = v.selector[a];
            ...
            ab = function(a) {
                ...
                return g.extend({ search: "none", order: "current", page: "todos" }, a);
            },
            bb = function(a) {
                for (var b = 0, c = a.length; b < c; b++)
                    if (0 < a[b].length)
                        ...
                        0 < D(g, "_details").length &&
                            (f.on("draw.dt.DT_details", function(a, b) {
                                ...
                                f.on("column-visibility.dt.DT_details", function(a, b) {
                                    if (e === b)
                                        for (var c, d = ba(b), f = 0, k = g.length; f < k; f++)
                                            (c = g[f]),
                                            c._details &&
                            ...
                            if (a === null || a === k || c) {
                                ...
                                for (t = h.length; p < t; p++) {
                                    ...
                                    for (s = 0; s < n; s++) {
                                        ...
                                        if (c) {
                                            v = b.aoData[l];
                                            a(u, y(b, l, s), v.anCells ? v.anCells[s] : null) &&
                                                m.push(u);
                                        } else m.push(u);
                                    }
                                }
            ...
            header: {
                ...
                jqueryui: function(a, b, c, d) {
                    g("<div/>")
                        ...
                        .append(b.contents())
                        .append(
                            g("<span/>").addClass(d.sSortIcon + " " + c.sSortingClassJUI)
                        )
                        .appendTo(b);
                    g(a.nTable).on("order.dt.DT", function(e, f, g, i) {
                        if (a === f) {
