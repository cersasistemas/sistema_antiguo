                    ...
                    <form action="<?php echo SERVERURL; ?>ajax/clienteAjax.php" method="POST" class="forms-sample" autocomplete="off">
                             ...
                             <div class="col-md-12">
                                ...
                                <div class=" col-md-4">
                                    ...
                                    <?php
                                        ...
                                        echo $insEstado->cargar_taller_nuevoalumno($datos[1]);
                                    ?> 
                                </div>
                                <div class=" col-md-4">
                                <div class="col-md-12 form-group">
                        ...
                        <div class="row">
                            ...
                            <div class=" col-md-6 form-group">
                                <button type="submit" name="agregar_alumno_taller" class="col-md-12 btn btn-success">Agregar</button>
                            </div>
                            <!--Cancelar-->
                            <div class="col-md-6 form-group">
